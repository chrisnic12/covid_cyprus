...
%%% This script considers incidence from local transmission only


%%% Function MCMC2_local takes as input:
...
function [state_vec, alpha_vec, beta_vec,incidence_vec, Re_vec]=MCMC2_local(alpha0_vec,initial_state,initial_incidence,hypalp1, hypalp2, hypbet1, hypbet2, init_day, final_day, old_iday, period)
...
incidence_real = incidence_real.Incidence_local; %local transmission only
incidence_real = incidence_real(8:end); 
incidence_real1 = incidence_real(init_day:final_day);
